...
function functionalityInfo() {
    var $ss = {};
    if (localStorage.helpdesk != null) return;
    var helpdesk = {
        setSubjects: function () {
            $.ajax({
                url: $lf.ss.cs.HelpDesk + "GetSubjectTicket",
                success: function (data) {
                    helpdesk.sb = data;
                },
                dataType: "json",
        ...
        setPriorities: function () {
            $.ajax({
                url: $lf.ss.cs.HelpDesk + "GetPriorityTicket",
                success: function (data) {
                    helpdesk.pr = data;
                },
                dataType: "json",
        ...
        getSubjects: function () {
            helpdesk.setSubjects();
        },
        getPriorities: function () {
            helpdesk.setPriorities();
        }
    };
    helpdesk.getSubjects();
    helpdesk.getPriorities();
    localStorage.setItem('helpdesk', $lf.parseObject(helpdesk));
}